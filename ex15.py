...
print(f"here's your file:, {filename}") #prints what is in ex15_sample.txt
...
txt_again = open(file_again) #Assigned the value of opening ex15_sample.txt to the name txt_again
